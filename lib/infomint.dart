...
class MiniMint extends StatefulWidget {
  const MiniMint({Key? key}) : super(key: key);

  @override
  _MiniMintState createState() => _MiniMintState();

}

class _MiniMintState extends State<MiniMint> {
  @override
