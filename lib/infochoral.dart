...
class MiniChoral extends StatefulWidget {
  const MiniChoral({Key? key}) : super(key: key);

  @override
  _MiniChoralState createState() => _MiniChoralState();

}

class _MiniChoralState extends State<MiniChoral> {
  @override
