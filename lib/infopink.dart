...
class MiniPink extends StatefulWidget {
  const MiniPink({Key? key}) : super(key: key);

  @override
  _MiniPinkState createState() => _MiniPinkState();

}

class _MiniPinkState extends State<MiniPink> {
  @override
